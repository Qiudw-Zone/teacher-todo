...
! function(e, t) {
	...
	function o() {
		dt.addEventListener ? (dt.removeEventListener("DOMContentLoaded", u, !1), e.removeEventListener("load", u, !1)) : (dt.detachEvent("onreadystatechange", u), e.detachEvent("onload", u))
	}
	...
	function l(e, t, n, r) {
		if (it.acceptData(e)) {
			var i, s, o = it.expando,
				...
				a = u ? it.cache : e,
				f = u ? e[o] : e[o] && o;
			if (f && a[f] && (r || a[f].data) || void 0 !== n || "string" != typeof t) return f || (f = u ? e[o] = J.pop() || it.guid++ : o), a[f] || (a[f] = u ? {} : {
				toJSON: it.noop
			}), ("object" == typeof t || "function" == typeof t) && (r ? a[f] = it.extend(a[f], t) : a[f].data = it.extend(a[f].data, t)), s = a[f], r || (s.data || (s.data = {}), s = s.data), void 0 !== n && (s[it.camelCase(t)] = n), "string" == typeof t ? (i = s[t], null == i && (i = s[it.camelCase(t)])) : i = s, i
		}
	}
		...
		if (it.acceptData(e)) {
			...
			if (o[u]) {
				if (t && (r = n ? o[u] : o[u].data)) {
					...
					if (n ? !f(r) : !it.isEmptyObject(r)) return
				}(n || (delete o[u].data, f(o[u]))) && (s ? it.cleanData([e], !0) : nt.deleteExpando || o != o.window ? delete o[u] : o[u] = null)
			}
		}
	}
	...
	function m(e, t) {
		...
		if (!s)
			for (s = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || it.nodeName(r, t) ? s.push(r) : it.merge(s, m(r, t));
	...
	function S(e, t) {
		if (1 === t.nodeType && it.hasData(e)) {
			...
			if (u) {
				...
				for (n in u)
					for (r = 0, i = u[n].length; i > r; r++) it.event.add(t, n, u[n][r])
			}
	...
	function L(e, t) {
		for (var n, r, i, s = [], o = 0, u = e.length; u > o; o++) r = e[o], r.style && (s[o] = it._data(r, "olddisplay"), n = r.style.display, t ? (s[o] || "none" !== n || (r.style.display = ""), "" === r.style.display && Lt(r) && (s[o] = it._data(r, "olddisplay", N(r.nodeName)))) : (i = Lt(r), (n && "none" !== n || !i) && it._data(r, "olddisplay", i ? n : it.css(r, "display"))));
	...
	function O(e, t, n, r, i) {
		for (var s = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > s; s += 2) "margin" === n && (o += it.css(e, n + kt[s], !0, i)), r ? ("content" === n && (o -= it.css(e, "padding" + kt[s], !0, i)), "margin" !== n && (o -= it.css(e, "border" + kt[s] + "Width", !0, i))) : (o += it.css(e, "padding" + kt[s], !0, i), "padding" !== n && (o += it.css(e, "border" + kt[s] + "Width", !0, i)));
		return o
	}
	...
	function M(e, t, n) {
		...
		if (0 >= i || null == i) {
			if (i = rn(e, t, s), (0 > i || null == i) && (i = e.style[t]), tn.test(i)) return i;
	...
	function H(e, t, n) {
		for (var r, i = (wn[t] || []).concat(wn["*"]), s = 0, o = i.length; o > s; s++)
	...
	function B(e, t, n) {
		var r, i, s, o, u, a, f, l, c = this,
			...
			d = e.nodeType && Lt(e),
			v = it._data(e, "fxshow");
		n.queue || (u = it._queueHooks(e, "fx"), null == u.unqueued && (u.unqueued = 0, a = u.empty.fire, u.empty.fire = function() {
			u.unqueued || a()
		}), u.unqueued++, c.always(function() {
			c.always(function() {
				u.unqueued--, it.queue(e, "fx").length || u.empty.fire()
			})
		})), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], f = it.css(e, "display"), l = "none" === f ? it._data(e, "olddisplay") || N(e.nodeName) : f, "inline" === l && "none" === it.css(e, "float") && (nt.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", nt.shrinkWrapBlocks() || c.always(function() {
		...
		for (r in t)
			if (i = t[r], mn.exec(i)) {
				...
				h[r] = v && v[r] || it.style(e, r)
			} else f = void 0;
		if (it.isEmptyObject(h)) "inline" === ("none" === f ? N(e.nodeName) : f) && (p.display = f);
		else {
			v ? "hidden" in v && (d = v.hidden) : v = it._data(e, "fxshow", {}), s && (v.hidden = !d), d ? it(e).show() : c.done(function() {
				it(e).hide()
			}), c.done(function() {
				var t;
	...
	function j(e, t) {
		var n, r, i, s, o;
		for (n in e)
			if (r = it.camelCase(n), i = t[r], s = e[n], it.isArray(s) && (i = s[1], s = e[n] = s[0]), n !== r && (e[r] = s, delete e[n]), o = it.cssHooks[r], o && "expand" in o) {
	...
	function F(e, t, n) {
		var r, i, s = 0,
			...
			a = function() {
				if (i) return !1;
				for (var t = dn || D(), n = Math.max(0, f.startTime + f.duration - t), r = n / f.duration || 0, s = 1 - r, o = 0, a = f.tweens.length; a > o; o++) f.tweens[o].run(s);
			...
			f = u.promise({
				...
				createTween: function(t, n) {
					var r = it.Tween(e, f.opts, t, n, f.opts.specialEasing[t] || f.opts.easing);
		...
		for (j(l, f.opts.specialEasing); o > s; s++)
			if (r = bn[s].call(f, e, l, f.opts)) return r;
		return it.map(l, H, f), it.isFunction(f.opts.start) && f.opts.start.call(e, f), it.fx.timer(it.extend(a, {
			elem: e,
			anim: f,
			queue: f.opts.queue
	...
	function q(e, t, n, r) {
		function i(u) {
			var a;
			return s[u] = !0, it.each(e[u] || [], function(e, u) {
				var f = u(t, n, r);
	...
	it.fn = it.prototype = {
		...
		var e, t, n, r, i, s, o = arguments[0] || {},
			...
			a = arguments.length,
			f = !1;
		for ("boolean" == typeof o && (f = o, o = arguments[u] || {}, u++), "object" == typeof o || it.isFunction(o) || (o = {}), u === a && (o = this, u--); a > u; u++)
			if (null != (i = arguments[u]))
				for (r in i) e = o[r], n = i[r], o !== n && (f && n && (it.isPlainObject(n) || (t = it.isArray(n))) ? (t ? (t = !1, s = e && it.isArray(e) ? e : []) : s = e && it.isPlainObject(e) ? e : {}, o[r] = it.extend(f, s, n)) : void 0 !== n && (o[r] = n));
		return o
	}, it.extend({
		...
		camelCase: function(e) {
			return e.replace(ot, "ms-").replace(ut, at)
		},
	...
	var ft = function(e) {
			...
			if (P && !r) {
				...
				if (E.qsa && (!H || !H.test(e))) {
					if (p = c = I, d = t, v = 9 === u && e, 1 === u && "object" !== t.nodeName.toLowerCase()) {
						f = N(e), (c = t.getAttribute("id")) ? p = c.replace(wt, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", a = f.length;
						while (a--) f[a] = p + h(f[a]);
		...
		function g(e, t, n, i, s, o) {
			return i && !i[I] && (i = g(i)), s && !s[I] && (s = g(s, o)), r(function(r, o, u, a) {
				var f, l, c, h = [],
					...
					b = n ? s || (r ? e : d || i) ? [] : o : y;
				if (n && n(y, b, u, a), i) {
					f = m(b, p), i(f, [], u, a), l = f.length;
					while (l--)(c = f[l]) && (b[p[l]] = !(y[p[l]] = c))
				}
				if (r) {
					if (s || e) {
						if (s) {
							f = [], l = b.length;
							while (l--)(c = b[l]) && f.push(y[l] = c);
							s(null, b = [], f, a)
						}
						l = b.length;
						while (l--)(c = b[l]) && (f = s ? tt.call(r, c) : h[l]) > -1 && (r[f] = !(o[f] = c))
					}
		...
		function b(e, n) {
			var i = n.length > 0,
				...
				o = function(r, o, u, a, f) {
					...
					if (p += d, i && d !== p) {
						c = 0;
						while (h = n[c++]) h(v, g, o, u);
						if (r) {
							if (p > 0)
								while (d--) v[d] || g[d] || (g[d] = G.call(a));
							g = m(g)
						}
			...
			filter: {
					...
					return 1 === r && 0 === i ? function(e) {
						...
						if (m) {
							...
							if (d = [o ? m.firstChild : m.lastChild], o && y) {
								l = m[I] || (m[I] = {}), f = l[e] || [], p = f[0] === R && f[1], h = f[0] === R && f[2], c = p && m.childNodes[p];
								...
								while (c = ++p && c && c[v] || (h = p = 0) || d.pop())
									if ((u ? c.nodeName.toLowerCase() === g : 1 === c.nodeType) && ++h && (y && ((c[I] || (c[I] = {}))[e] = [R, h]), c === t)) break;
				...
				PSEUDO: function(e, n) {
					...
					return s[I] ? s(n) : s.length > 1 ? (i = [e, e, "", n], S.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
						var r, i = s(e, n),
							o = i.length;
						while (o--) r = tt.call(e, i[o]), e[r] = !(t[r] = i[o])
					}) : function(e) {
						return s(e, 0, i)
					}) : s
				}
		...
		return c.prototype = S.filters = S.pseudos, S.setFilters = new c, N = t.tokenize = function(e, n) {
			...
			if (n = n || [], 1 === c.length) {
				...
				i = dt.needsContext.test(e) ? 0 : s.length;
				while (i--) {
					if (o = s[i], S.relative[u = o.type]) break;
	...
	it.find = ft, it.expr = ft.selectors, it.expr[":"] = it.expr.pseudos, it.unique = ft.uniqueSort, it.text = ft.getText, it.isXMLDoc = ft.isXML, it.contains = ft.contains;
	...
	it.filter = function(e, t, n) {
		...
		is: function(e) {
			return !!r(this, "string" == typeof e && lt.test(e) ? it(e) : e || [], !1).length
		}
	});
	var pt, dt = e.document,
		...
		mt = it.fn.init = function(e, t) {
			...
			if ("string" == typeof e) {
				...
				if (n[1]) {
					if (t = t instanceof it ? t[0] : t, it.merge(this, it.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : dt, !0)), ct.test(n[1]) && it.isPlainObject(t))
	...
	it.extend({
		dir: function(e, t, n) {
			var r = [],
				i = e[t];
			while (i && 9 !== i.nodeType && (void 0 === n || 1 !== i.nodeType || !it(i).is(n))) 1 === i.nodeType && r.push(i), i = i[t];
			return r
		},
		...
		closest: function(e, t) {
			for (var n, r = 0, i = this.length, s = [], o = lt.test(e) || "string" != typeof e ? it(e, t || this.context) : 0; i > r; r++)
		...
		it.fn[e] = function(n, r) {
			...
			return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = it.filter(r, i)), this.length > 1 && (yt[e] || (i = it.unique(i)), gt.test(e) && (i = i.reverse())), this.pushStack(i)
		}
	});
	var bt = /\S+/g,
		wt = {};
	it.Callbacks = function(e) {
		...
		var t, n, r, i, o, u, a = [],
			...
			c = {
				...
				remove: function() {
					return a && it.each(arguments, function(e, n) {
						var r;
						while ((r = it.inArray(n, a, r)) > -1) a.splice(r, 1), t && (i >= r && i--, o >= r && o--)
					}), this
				},
				has: function(e) {
					return e ? it.inArray(e, a) > -1 : !!a && !!a.length
				},
				empty: function() {
					return a = [], i = 0, this
				},
		...
		when: function(e) {
			var t = 0,
				n = K.call(arguments),
				r = n.length,
				i = 1 !== r || e && it.isFunction(e.promise) ? r : 0,
				s = 1 === i ? e : it.Deferred(),
				o = function(e, t, n) {
					return function(r) {
				...
				u, a, f;
			if (r > 1)
				for (u = new Array(r), a = new Array(r), f = new Array(r); r > t; t++) n[t] && it.isFunction(n[t].promise) ? n[t].promise().done(o(t, f, n)).fail(s.reject).progress(o(t, a, u)) : --i;
	...
	it.fn.ready = function(e) {
		...
		ready: function(e) {
			if (e === !0 ? !--it.readyWait : !it.isReady) {
				...
				it.isReady = !0, e !== !0 && --it.readyWait > 0 || (Et.resolveWith(dt, [it]), it.fn.triggerHandler && (it(dt).triggerHandler("ready"), it(dt).off("ready")))
			}
		}
	}), it.ready.promise = function(t) {
		if (!Et)
			if (Et = it.Deferred(), "complete" === dt.readyState) setTimeout(it.ready);
			else if (dt.addEventListener) dt.addEventListener("DOMContentLoaded", u, !1), e.addEventListener("load", u, !1);
		else {
			dt.attachEvent("onreadystatechange", u), e.attachEvent("onload", u);
			var n = !1;
			try {
	...
	it.extend({
		...
		hasData: function(e) {
			return e = e.nodeType ? it.cache[e[it.expando]] : e[it.expando], !!e && !f(e)
		},
		data: function(e, t, n) {
			return l(e, t, n)
		},
		...
		data: function(e, t) {
			...
			if (void 0 === e) {
				if (this.length && (i = it.data(s), 1 === s.nodeType && !it._data(s, "parsedAttrs"))) {
					n = o.length;
					while (n--) o[n] && (r = o[n].name, 0 === r.indexOf("data-") && (r = it.camelCase(r.slice(5)), a(s, r, i[r])));
		...
		promise: function(e, t) {
			...
			while (o--) n = it._data(s[o], e + "queueHooks"), n && n.empty && (r++, n.empty.add(u));
	...
	var Ct = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		At = it.access = function(e, t, n, r, i, s, o) {
			var u = 0,
				a = e.length,
				f = null == n;
			if ("object" === it.type(n)) {
				i = !0;
				for (u in n) it.access(e, t, u, n[u], !0, s, o)
			} else if (void 0 !== r && (i = !0, it.isFunction(r) || (o = !0), f && (o ? (t.call(e, r), t = null) : (f = t, t = function(e, t, n) {
					return f.call(it(e), n)
				})), t))
	...
	it.event = {
		...
		add: function(e, t, n, r, i) {
			var s, o, u, a, f, l, c, h, p, d, v, m = it._data(e);
			if (m) {
				n.handler && (a = n, n = a.handler, i = a.selector), n.guid || (n.guid = it.guid++), (o = m.events) || (o = m.events = {}), (l = m.handle) || (l = m.handle = function(e) {
					return typeof it === St || e && it.event.triggered === e.type ? void 0 : it.event.dispatch.apply(l.elem, arguments)
				}, l.elem = e), t = (t || "").match(bt) || [""], u = t.length;
				while (u--) s = Ht.exec(t[u]) || [], p = v = s[1], d = (s[2] || "").split(".").sort(), p && (f = it.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = it.event.special[p] || {}, c = it.extend({
					type: p,
					origType: v,
					data: r,
					handler: n,
					...
					namespace: d.join(".")
				}, a), (h = o[p]) || (h = o[p] = [], h.delegateCount = 0, f.setup && f.setup.call(e, r, d, l) !== !1 || (e.addEventListener ? e.addEventListener(p, l, !1) : e.attachEvent && e.attachEvent("on" + p, l))), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), i ? h.splice(h.delegateCount++, 0, c) : h.push(c), it.event.global[p] = !0);
				e = null
			}
		},
		remove: function(e, t, n, r, i) {
			var s, o, u, a, f, l, c, h, p, d, v, m = it.hasData(e) && it._data(e);
			if (m && (l = m.events)) {
				t = (t || "").match(bt) || [""], f = t.length;
				while (f--)
					if (u = Ht.exec(t[f]) || [], p = v = u[1], d = (u[2] || "").split(".").sort(), p) {
						c = it.event.special[p] || {}, p = (r ? c.delegateType : c.bindType) || p, h = l[p] || [], u = u[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = s = h.length;
						...
						a && !h.length && (c.teardown && c.teardown.call(e, d, m.handle) !== !1 || it.removeEvent(e, p, m.handle), delete l[p])
					} else
						for (p in l) it.event.remove(e, p + t[f], n, r, !0);
				it.isEmptyObject(l) && (delete m.handle, it._removeData(e, "events"))
			}
		},
		trigger: function(t, n, r, i) {
			var s, o, u, a, f, l, c, h = [r || dt],
				p = tt.call(t, "type") ? t.type : t,
				d = tt.call(t, "namespace") ? t.namespace.split(".") : [];
			if (u = l = r = r || dt, 3 !== r.nodeType && 8 !== r.nodeType && !Pt.test(p + it.event.triggered) && (p.indexOf(".") >= 0 && (d = p.split("."), p = d.shift(), d.sort()), o = p.indexOf(":") < 0 && "on" + p, t = t[it.expando] ? t : new it.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = d.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : it.makeArray(n, [t]), f = it.event.special[p] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
				if (!i && !f.noBubble && !it.isWindow(r)) {
					for (a = f.delegateType || p, Pt.test(a + p) || (u = u.parentNode); u; u = u.parentNode) h.push(u), l = u;
					l === (r.ownerDocument || dt) && h.push(l.defaultView || l.parentWindow || e)
				}
				c = 0;
				while ((u = h[c++]) && !t.isPropagationStopped()) t.type = c > 1 ? a : f.bindType || p, s = (it._data(u, "events") || {})[t.type] && it._data(u, "handle"), s && s.apply(u, n), s = o && u[o], s && s.apply && it.acceptData(u) && (t.result = s.apply(u, n), t.result === !1 && t.preventDefault());
				if (t.type = p, !i && !t.isDefaultPrevented() && (!f._default || f._default.apply(h.pop(), n) === !1) && it.acceptData(r) && o && r[p] && !it.isWindow(r)) {
					l = r[o], l && (r[o] = null), it.event.triggered = p;
					try {
						r[p]()
					} catch (v) {}
					it.event.triggered = void 0, l && (r[o] = l)
				}
				return t.result
			}
		},
		dispatch: function(e) {
			...
			var t, n, r, i, s, o = [],
				u = K.call(arguments),
				a = (it._data(this, "events") || {})[e.type] || [],
				f = it.event.special[e.type] || {};
			if (u[0] = e, e.delegateTarget = this, !f.preDispatch || f.preDispatch.call(this, e) !== !1) {
				o = it.event.handlers.call(this, e, a), t = 0;
				while ((i = o[t++]) && !e.isPropagationStopped()) {
					e.currentTarget = i.elem, s = 0;
					while ((r = i.handlers[s++]) && !e.isImmediatePropagationStopped())(!e.namespace_re || e.namespace_re.test(r.namespace)) && (e.handleObj = r, e.data = r.data, n = ((it.event.special[r.origType] || {}).handle || r.handler).apply(i.elem, u), void 0 !== n && (e.result = n) === !1 && (e.preventDefault(), e.stopPropagation()))
				}
			...
			if (u && a.nodeType && (!e.button || "click" !== e.type))
				for (; a != this; a = a.parentNode || this)
					if (1 === a.nodeType && (a.disabled !== !0 || "click" !== e.type)) {
						for (i = [], s = 0; u > s; s++) r = t[s], n = r.selector + " ", void 0 === i[n] && (i[n] = r.needsContext ? it(n, this).index(a) >= 0 : it.find(n, this, null, [a]).length), i[n] && i.push(r);
						i.length && o.push({
							elem: a,
							handlers: i
						})
		...
		fix: function(e) {
			...
			var t, n, r, i = e.type,
				s = e,
				o = this.fixHooks[i];
			o || (this.fixHooks[i] = o = Dt.test(i) ? this.mouseHooks : _t.test(i) ? this.keyHooks : {}), r = o.props ? this.props.concat(o.props) : this.props, e = new it.Event(s), t = r.length;
			while (t--) n = r[t], e[n] = s[n];
			return e.target || (e.target = s.srcElement || dt), 3 === e.target.nodeType && (e.target = e.target.parentNode), e.metaKey = !!e.metaKey, o.filter ? o.filter(e, s) : e
		},
		...
		return this instanceof it.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? h : p) : this.type = e, t && it.extend(this, t), this.timeStamp = e && e.timeStamp || it.now(), void(this[it.expando] = !0)) : new it.Event(e, t)
	}, it.Event.prototype = {
	...
	var Bt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
		...
		Qt = v(dt),
		Gt = Qt.appendChild(dt.createElement("div"));
	Kt.optgroup = Kt.option, Kt.tbody = Kt.tfoot = Kt.colgroup = Kt.caption = Kt.thead, Kt.th = Kt.td, it.extend({
		clone: function(e, t, n) {
			var r, i, s, o, u, a = it.contains(e.ownerDocument, e);
			if (nt.html5Clone || it.isXMLDoc(e) || !Ft.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (Gt.innerHTML = e.outerHTML, Gt.removeChild(s = Gt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || it.isXMLDoc(e)))
		...
		buildFragment: function(e, t, n, r) {
			for (var i, s, o, u, a, f, l, c = e.length, h = v(t), p = [], d = 0; c > d; d++)
				...
				u = u || h.appendChild(t.createElement("div")), a = (Rt.exec(s) || ["", ""])[1].toLowerCase(), l = Kt[a] || Kt._default, u.innerHTML = l[1] + s.replace(qt, "<$1></$2>") + l[2], i = l[0];
				while (i--) u = u.lastChild;
				if (!nt.leadingWhitespace && It.test(s) && p.push(t.createTextNode(It.exec(s)[0])), !nt.tbody) {
					s = "table" !== a || Ut.test(s) ? "<table>" !== l[1] || Ut.test(s) ? 0 : u : u.firstChild, i = s && s.childNodes.length;
					while (i--) it.nodeName(f = s.childNodes[i], "tbody") && !f.childNodes.length && s.removeChild(f)
				}
				it.merge(p, u.childNodes), u.textContent = "";
				while (u.firstChild) u.removeChild(u.firstChild);
				u = h.lastChild
			} else p.push(t.createTextNode(s));
			u && h.removeChild(u), nt.appendChecked || it.grep(m(p, "input"), g), d = 0;
			while (s = p[d++])
				if ((!r || -1 === it.inArray(s, r)) && (o = it.contains(s.ownerDocument, s), u = m(h.appendChild(s), "script"), o && E(u), n)) {
					i = 0;
		...
		cleanData: function(e, t) {
			for (var n, r, i, s, o = 0, u = it.expando, a = it.cache, f = nt.deleteExpando, l = it.event.special; null != (n = e[o]); o++)
				if ((t || it.acceptData(n)) && (i = n[u], s = i && a[i])) {
					if (s.events)
						for (r in s.events) l[r] ? it.event.remove(n, r) : it.removeEvent(n, r, s.handle);
					a[i] && (delete a[i], f ? delete n[u] : typeof n.removeAttribute !== St ? n.removeAttribute(u) : n[u] = null, J.push(i))
				}
		}
	}), it.fn.extend({
		text: function(e) {
		...
		remove: function(e, t) {
			for (var n, r = e ? it.filter(e, this) : this, i = 0; null != (n = r[i]); i++) t || 1 !== n.nodeType || it.cleanData(m(n)), n.parentNode && (t && it.contains(n.ownerDocument, n) && E(m(n, "script")), n.parentNode.removeChild(n));
			return this
		},
		empty: function() {
			for (var e, t = 0; null != (e = this[t]); t++) {
				1 === e.nodeType && it.cleanData(m(e, !1));
		...
		html: function(e) {
			return At(this, function(e) {
				...
				if (!("string" != typeof e || Wt.test(e) || !nt.htmlSerialize && Ft.test(e) || !nt.leadingWhitespace && It.test(e) || Kt[(Rt.exec(e) || ["", ""])[1].toLowerCase()])) {
					e = e.replace(qt, "<$1></$2>");
					try {
		...
		domManip: function(e, t) {
			...
			var n, r, i, s, o, u, a = 0,
				...
				h = e[0],
				p = it.isFunction(h);
			if (p || f > 1 && "string" == typeof h && !nt.checkClone && Xt.test(h)) return this.each(function(n) {
				var r = l.eq(n);
				p && (e[0] = h.call(this, n, r.html())), r.domManip(e, t)
			});
			if (f && (u = it.buildFragment(e, this[0].ownerDocument, !1, this), n = u.firstChild, 1 === u.childNodes.length && (u = n), n)) {
				for (s = it.map(m(u, "script"), b), i = s.length; f > a; a++) r = u, a !== c && (r = it.clone(r, !0, !0), i && it.merge(s, m(r, "script"))), t.call(this[a], r, a);
				if (i)
					for (o = s[s.length - 1].ownerDocument, it.map(s, w), a = 0; i > a; a++) r = s[a], Vt.test(r.type || "") && !it._data(r, "globalEval") && it.contains(o, r) && (r.src ? it._evalUrl && it._evalUrl(r.src) : it.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Jt, "")));
				u = n = null
			}
			return this
		}
		...
		it.fn[e] = function(e) {
			for (var n, r = 0, i = [], s = it(e), o = s.length - 1; o >= r; r++) n = r === o ? this : this.clone(!0), it(s[r])[t](n), G.apply(i, n.get());
	...
	var en = /^margin/,
		tn = new RegExp("^(" + Ct + ")(?!px)[a-z%]+$", "i"),
		nn, rn, sn = /^(top|right|bottom|left)$/;
	e.getComputedStyle ? (nn = function(e) {
		return e.ownerDocument.defaultView.getComputedStyle(e, null)
	}, rn = function(e, t, n) {
		var r, i, s, o, u = e.style;
		return n = n || nn(e), o = n ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== o || it.contains(e.ownerDocument, e) || (o = it.style(e, t)), tn.test(o) && en.test(t) && (r = u.width, i = u.minWidth, s = u.maxWidth, u.minWidth = u.maxWidth = u.width = o, o = n.width, u.width = r, u.minWidth = i, u.maxWidth = s)), void 0 === o ? o : o + ""
	}) : dt.documentElement.currentStyle && (nn = function(e) {
		return e.currentStyle
	}, rn = function(e, t, n) {
		var r, i, s, o, u = e.style;
		return n = n || nn(e), o = n ? n[t] : void 0, null == o && u && u[t] && (o = u[t]), tn.test(o) && !sn.test(t) && (r = u.left, i = e.runtimeStyle, s = i && i.left, s && (i.left = e.currentStyle.left), u.left = "fontSize" === t ? "1em" : o, o = u.pixelLeft + "px", u.left = r, s && (i.left = s)), void 0 === o ? o : o + "" || "auto"
	}), ! function() {
		var t, n, r, i, s, o, u;
		if (t = dt.createElement("div"), t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", r = t.getElementsByTagName("a")[0], n = r && r.style) {
			n.cssText = "float:left;opacity:.5", nt.opacity = "0.5" === n.opacity, nt.cssFloat = !!n.cssFloat, t.style.backgroundClip = "content-box", t.cloneNode(!0).style.backgroundClip = "", nt.clearCloneStyle = "content-box" === t.style.backgroundClip, nt.boxSizing = "" === n.boxSizing || "" === n.MozBoxSizing || "" === n.WebkitBoxSizing, it.extend(nt, {
			...
			function a() {
				var t, n, r, a;
				n = dt.getElementsByTagName("body")[0], n && n.style && (t = dt.createElement("div"), r = dt.createElement("div"), r.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(r).appendChild(t), t.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", i = s = !1, u = !0, e.getComputedStyle && (i = "1%" !== (e.getComputedStyle(t, null) || {}).top, s = "4px" === (e.getComputedStyle(t, null) || {
					width: "4px"
				}).width, a = t.appendChild(dt.createElement("div")), a.style.cssText = t.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", a.style.marginRight = a.style.width = "0", t.style.width = "1px", u = !parseFloat((e.getComputedStyle(a, null) || {}).marginRight)), t.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", a = t.getElementsByTagName("td"), a[0].style.cssText = "margin:0;border:0;padding:0;display:none", o = 0 === a[0].offsetHeight, o && (a[0].style.display = "", a[1].style.display = "none", o = 0 === a[0].offsetHeight), n.removeChild(r))
			}
		}
	...
	it.extend({
		...
		style: function(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var i, s, o, u = it.camelCase(t),
					a = e.style;
				if (t = it.cssProps[u] || (it.cssProps[u] = k(a, u)), o = it.cssHooks[t] || it.cssHooks[u], void 0 === n) return o && "get" in o && void 0 !== (i = o.get(e, !1, r)) ? i : a[t];
				if (s = typeof n, "string" === s && (i = ln.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(it.css(e, t)), s = "number"), null != n && n === n && ("number" !== s || it.cssNumber[u] || (n += "px"), nt.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (a[t] = "inherit"), !(o && "set" in o && void 0 === (n = o.set(e, n, r))))) try {
					a[t] = n
				} catch (f) {}
			}
		},
		css: function(e, t, n, r) {
			var i, s, o, u = it.camelCase(t);
			return t = it.cssProps[u] || (it.cssProps[u] = k(e.style, u)), o = it.cssHooks[t] || it.cssHooks[u], o && "get" in o && (s = o.get(e, !0, n)), void 0 === s && (s = rn(e, t, r)), "normal" === s && t in hn && (s = hn[t]), "" === n || n ? (i = parseFloat(s), n === !0 || it.isNumeric(i) ? i || 0 : s) : s
		}
	}), it.each(["height", "width"], function(e, t) {
		it.cssHooks[t] = {
			get: function(e, n, r) {
				return n ? an.test(it.css(e, "display")) && 0 === e.offsetWidth ? it.swap(e, cn, function() {
					return M(e, t, r)
				}) : M(e, t, r) : void 0
			},
			set: function(e, n, r) {
				var i = r && nn(e);
				return A(e, n, r ? O(e, t, r, nt.boxSizing && "border-box" === it.css(e, "boxSizing", !1, i), i) : 0)
			}
		}
		...
		set: function(e, t) {
			...
			n.zoom = 1, (t >= 1 || "" === t) && "" === it.trim(s.replace(on, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || r && !r.filter) || (n.filter = on.test(s) ? s.replace(on, i) : s + " " + i)
		}
		...
		it.cssHooks[e + t] = {
			expand: function(n) {
				for (var r = 0, i = {}, s = "string" == typeof n ? n.split(" ") : [n]; 4 > r; r++) i[e + kt[r] + t] = s[r] || s[r - 2] || s[0];
				return i
			}
		}, en.test(e) || (it.cssHooks[e + t].set = A)
	}), it.fn.extend({
		css: function(e, t) {
			return At(this, function(e, t, n) {
				var r, i, s = {},
					o = 0;
				if (it.isArray(t)) {
					for (r = nn(e), i = t.length; i > o; o++) s[t[o]] = it.css(e, t[o], !1, r);
					return s
				}
	...
	var dn, vn, mn = /^(?:toggle|show|hide)$/,
		gn = new RegExp("^(?:([+-])=|)(" + Ct + ")([a-z%]*)$", "i"),
		yn = /queueHooks$/,
		bn = [B],
		wn = {
			"*": [function(e, t) {
				var n = this.createTween(e, t),
					...
					o = (it.cssNumber[e] || "px" !== s && +r) && gn.exec(it.css(n.elem, e)),
					u = 1,
					a = 20;
				if (o && o[3] !== s) {
					s = s || o[3], i = i || [], o = +r || 1;
					do u = u || ".5", o /= u, it.style(n.elem, e, o + s); while (u !== (u = n.cur() / r) && 1 !== u && --a)
				}
			...
			stop: function(e, t, n) {
				...
				return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function() {
					...
					if (i) o[i] && o[i].stop && r(o[i]);
						...
						for (i in o) o[i] && o[i].stop && yn.test(i) && r(o[i]);
	...
	it.fn.extend({
		val: function(e) {
			...
			if (i) return t = it.valHooks[i.type] || it.valHooks[i.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(En, "") : null == n ? "" : n)
		}
	}), it.extend({
		valHooks: {
			option: {
			...
			select: {
				get: function(e) {
					for (var t, n, r = e.options, i = e.selectedIndex, s = "select-one" === e.type || 0 > i, o = s ? null : [], u = s ? i + 1 : r.length, a = 0 > i ? u : s ? i : 0; u > a; a++)
						if (n = r[a], !(!n.selected && a !== i || (nt.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && it.nodeName(n.parentNode, "optgroup"))) {
				...
				set: function(e, t) {
					var n, r, i = e.options,
						...
						o = i.length;
					while (o--)
						if (r = i[o], it.inArray(it.valHooks.option.get(r), s) >= 0) try {
							r.selected = n = !0
						} catch (u) {
							r.scrollHeight
						} else r.selected = !1;
	...
	var Sn, xn, Tn = it.expr.attrHandle,
	...
	it.fn.extend({
		...
		attr: function(e, t, n) {
			var r, i, s = e.nodeType;
			if (e && 3 !== s && 8 !== s && 2 !== s) return typeof e.getAttribute === St ? it.prop(e, t, n) : (1 === s && it.isXMLDoc(e) || (t = t.toLowerCase(), r = it.attrHooks[t] || (it.expr.match.bool.test(t) ? xn : Sn)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = it.find.attr(e, t), null == i ? void 0 : i) : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void it.removeAttr(e, t))
		},
		removeAttr: function(e, t) {
			var n, r, i = 0,
				s = t && t.match(bt);
			if (s && 1 === e.nodeType)
				while (n = s[i++]) r = it.propFix[n] || n, it.expr.match.bool.test(n) ? kn && Cn || !Nn.test(n) ? e[r] = !1 : e[it.camelCase("default-" + n)] = e[r] = !1 : it.attr(e, n, ""), e.removeAttribute(Cn ? n : r)
		},
		attrHooks: {
			type: {
				set: function(e, t) {
		...
		set: function(e, t, n) {
			return t === !1 ? it.removeAttr(e, n) : kn && Cn || !Nn.test(n) ? e.setAttribute(!Cn && it.propFix[n] || n, n) : e[it.camelCase("default-" + n)] = e[n] = !0, n
		}
	}, it.each(it.expr.match.bool.source.match(/\w+/g), function(e, t) {
		var n = Tn[t] || it.find.attr;
		Tn[t] = kn && Cn || !Nn.test(t) ? function(e, t, r) {
			var i, s;
	...
	it.fn.extend({
		...
		prop: function(e, t, n) {
			...
			if (e && 3 !== o && 8 !== o && 2 !== o) return s = 1 !== o || !it.isXMLDoc(e), s && (t = it.propFix[t] || t, i = it.propHooks[t]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t]
		},
		propHooks: {
			tabIndex: {
				get: function(e) {
					var t = it.find.attr(e, "tabindex");
					return t ? parseInt(t, 10) : Ln.test(e.nodeName) || An.test(e.nodeName) && e.href ? 0 : -1
				}
			}
		}
	...
	it.fn.extend({
		addClass: function(e) {
			...
			if (f)
				for (t = (e || "").match(bt) || []; a > u; u++)
					if (n = this[u], r = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(On, " ") : " ")) {
						s = 0;
	...
	it.parseJSON = function(t) {
		...
		var n, r = null,
			i = it.trim(t + "");
		return i && !it.trim(i.replace(Dn, function(e, t, i, s) {
	...
	try {
		...
		Hn = dt.createElement("a"), Hn.href = "", Hn = Hn.href
	}
	Pn = Un.exec(Hn.toLowerCase()) || [], it.extend({
		active: 0,
		lastModified: {},
		etag: {},
		ajaxSettings: {
		...
		ajax: function(e, t) {
			...
			var r, i, s, o, u, a, f, l, c = it.ajaxSetup({}, t),
				h = c.context || c,
				p = c.context && (h.nodeType || h.jquery) ? it(h) : it.event,
				d = it.Deferred(),
				...
				E = {
					...
					getResponseHeader: function(e) {
						...
						if (2 === b) {
							if (!l) {
								l = {};
								while (t = Fn.exec(o)) l[t[1].toLowerCase()] = t[2]
							}
							t = l[e.toLowerCase()]
						}
			...
			a = c.global, a && 0 === it.active++ && it.event.trigger("ajaxStart"), c.type = c.type.toUpperCase(), c.hasContent = !qn.test(c.type), s = c.url, c.hasContent || (c.data && (s = c.url += (_n.test(s) ? "&" : "?") + c.data, delete c.data), c.cache === !1 && (c.url = jn.test(s) ? s.replace(jn, "$1_=" + Mn++) : s + (_n.test(s) ? "&" : "?") + "_=" + Mn++)), c.ifModified && (it.lastModified[s] && E.setRequestHeader("If-Modified-Since", it.lastModified[s]), it.etag[s] && E.setRequestHeader("If-None-Match", it.etag[s])), (c.data && c.hasContent && c.contentType !== !1 || t.contentType) && E.setRequestHeader("Content-Type", c.contentType), E.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + ("*" !== c.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : c.accepts["*"]);
			for (i in c.headers) E.setRequestHeader(i, c.headers[i]);
			if (!c.beforeSend || c.beforeSend.call(h, E, c) !== !1 && 2 !== b) {
				w = "abort";
				for (i in {
						success: 1,
						error: 1,
	...
	it.param = function(e, t) {
		...
		serializeArray: function() {
			return this.map(function() {
				...
				var e = this.type;
				return this.name && !it(this).is(":disabled") && Gn.test(this.nodeName) && !Qn.test(e) && (this.checked || !Ot.test(e))
			}).map(function(e, t) {
				var n = it(this).val();
				...
				send: function(n, r) {
					...
					s.send(e.hasContent && e.data || null), t = function(n, i) {
						...
						if (t && (i || 4 === s.readyState))
							if (delete Zn[o], t = void 0, s.onreadystatechange = it.noop, i) 4 !== s.readyState && s.abort();
							else {
	...
	it.ajaxSetup({
		...
		return u || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = it.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, u ? t[u] = t[u].replace(nr, "$1" + i) : t.jsonp !== !1 && (t.url += (_n.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
			return o || it.error(i + " was not called"), o[0]
		}, t.dataTypes[0] = "json", s = e[i], e[i] = function() {
			o = arguments
		}, r.always(function() {
			e[i] = s, t[i] && (t.jsonpCallback = n.jsonpCallback, tr.push(i)), o && it.isFunction(s) && s(o[0]), o = s = void 0
		}), "script") : void 0
	...
	it.fn.load = function(e, t, n) {
		...
		var r, i, s, o = this,
			u = e.indexOf(" ");
		return u >= 0 && (r = it.trim(e.slice(u, e.length)), e = e.slice(0, u)), it.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (s = "POST"), o.length > 0 && it.ajax({
			url: e,
			type: s,
			dataType: "html",
			data: t
	...
	it.offset = {
		setOffset: function(e, t, n) {
			var r, i, s, o, u, a, f, l = it.css(e, "position"),
				c = it(e),
				h = {};
			"static" === l && (e.style.position = "relative"), u = c.offset(), s = it.css(e, "top"), a = it.css(e, "left"), f = ("absolute" === l || "fixed" === l) && it.inArray("auto", [s, a]) > -1, f ? (r = c.position(), o = r.top, i = r.left) : (o = parseFloat(s) || 0, i = parseFloat(a) || 0), it.isFunction(t) && (t = t.call(e, n, u)), null != t.top && (h.top = t.top - u.top + o), null != t.left && (h.left = t.left - u.left + i), "using" in t ? t.using.call(e, h) : c.css(h)
		}
	}, it.fn.extend({
		offset: function(e) {
		...
		offsetParent: function() {
			return this.map(function() {
				...
				while (e && !it.nodeName(e, "html") && "static" === it.css(e, "position")) e = e.offsetParent;
				return e || ir
			})
		}
	}), it.each({
		...
		it.cssHooks[t] = C(nt.pixelPosition, function(e, n) {
			return n ? (n = rn(e, t), tn.test(n) ? it(e).position()[t] + "px" : n) : void 0
		})
	}), it.each({
		Height: "height",
		Width: "width"
	...
	return it.noConflict = function(t) {
		return e.$ === it && (e.$ = or), t && e.jQuery === it && (e.jQuery = sr), it
